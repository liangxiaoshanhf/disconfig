...
public class DisconfMgr implements ApplicationContextAware {
    ...
    public   String getProperties(String key){
    	String value = null;
    	org.springframework.core.env.Environment environment = applicationContext.getBean(org.springframework.core.env.Environment.class);
    	if(environment!=null  ){
    ...
    public   InputStream getInputStream(String key){
    	InputStream value = null;
    	 if(key!=null  ){
    		  value = Thread.currentThread().getContextClassLoader().getResourceAsStream(key);
     	}
    	return value;
    }
}
